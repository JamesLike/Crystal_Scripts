...
# Edits here:
#########################
CELL_FILENAME="/home/james/data/crystallography/LCLS_LR23/cell.cell"
POINTGROUP="mmm"
HIGHRES=1.80
HIGHRES2=1.50
HIGHRES3=1.35
...
loc="~/PycharmProjects/Crystal_Scripts/Cryst_FEL" # This should be pointing to the directory of crystfel_stats_merge.sh no need for a / to follow
