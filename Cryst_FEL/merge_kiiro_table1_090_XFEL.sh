...
loc="~/PycharmProjects/Crystal_Scripts/" # This should be pointing to the directory of crystfel_stats_merge.sh no need for a / to follow
...
images=$(grep 'Begin cry' ../*.stream | wc -l)
