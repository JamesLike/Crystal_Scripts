...
#~/progs/cctbx/build/bin/cctbx.python ~/progs/cctbx/modules/cctbx_project/mmtbx/command_line/fobs_minus_fobs_map.py f_obs_1_file=$light_obs f_obs_2_file=$dark_obs phase_source=$dark_model multiscale=True output_file=phenix_Fobs_Fobs.mtz 
