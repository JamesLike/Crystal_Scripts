! PROGRAM TO ADD TWO DATA SETS WITHOUT PHASES
! USED TO ADD WEIGHTED DIFFERENCE AMPLITUDES TO FCs.
! FCs ARE PREFERRED BECAUSE THE PROVIDE THE BEST
! CHEMICAL INFORMATION YOU CAN INTRODUCE
! 
! 
!
! TYPICAL INPUT FILE
! ../process/DATA_SETS/PYP_6D.phs                                INPUT FCS OF GROUND STATE
! ../process/DATA_SETS/PYP_500us_6D_w2.phs                       INPUT F (IF WEIGHTED NO SIGMAS AVAIL.) 
! ../process/DATA_SETS/PYP_13_500us_sm.hkl                       SIGMAS
! 500us_6D.hkl                                                   OUTPUT FOR CNS
! 500us_6D.phs                                                   OUTPUT FOR XTALVIEW 
! 5          							 5 TIMES DF ADDED 
!
! SIGMAS: SIGMAOUT= SQRT(S1)*SIGMA(DELTAF) 
...
! TIME RESOLVED DATA SET (DATA SET 1) WILL BE READ IN LATER TO PRESERVE ORDER
!
...
! READ DIFFERENCE STRUCTURE FACTORS (DF AND WEIGHT)  
I3 = 0
1500      CONTINUE
...
! READ SIGMA OF STRUCTURE FACTORS (SIGMA)
I4 = 0
1700      CONTINUE
...
! LOOP OVER DARK DATA SET TO PRESERVE ORDER
! FINS(IH,K,L,1)  IS DELTA_F 
! FINS(IH,K,L,2)  IS SIGMA 
! USE FCALC
I1 = 0
I2 = 0
EPS = 20.0
