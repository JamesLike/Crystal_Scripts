! PROGRAM TO SUBSTRACT TWO DATA SETS WITH PHASES
! USED TO GENERATE TIME DEPENDEND PHASES FROM MOCK DATA
!      CAN ALSO BE USED TO GENERATE PURE INTERMEDIATE DIFF STR. FACTORS
! TYPICAL INPUT
! MOCK FC DATA SCALED TO FC DARK : MOCK1_sm.hkl 
! MOCK FC PHASES                 : MOCK1.phs
! DARK FC AMPLITUDES AND PHASES  : 2phy_5dk.phs
! SEE SCHMIDT et al., 2003, Biophys J.

!
! READ MOCK DATA SCALED TO DARK
! FILE: H K L F SIGMA
!
...
I = 0
900   CONTINUE
! CHANGE HERE FOR MOCK ==========>   <======= FCD-FCL
!      READ(IN,*,END=1000) IH,K,L,DUM,FSM
...
! READ DARK DATA AMPLITUDES AND PHASES
IOUT = 11
OPEN(UNIT = IN, FILE = FDARK, STATUS = 'OLD', ERR = 2700)
OPEN(UNIT = IOUT, FILE = FDIFF)
I = 0
1700  CONTINUE
!          hkl fc 0 phs ==========>    <====== hkl fo fc phs
!       READ(IN,*,END=2200) IH,K,L,DUM,FCD,PHICD
