...
C NOTE: PROGRAM NOT GENERAL FOR ALL CCP4 MAPS
C ONLY FOR GRID ORDERS AS IN CCP4 MAPS AS IN PYP
C
C ===========================================
C
...
C 
C ALGORITHM
C READ IN EXTRAPOLATED MAP
C SPECIFY MASK (COORDINATES AND RADIUS)
C SUM ALL GRID POINTS IN THE MASK < SPECIFIED SIGMA
C 
C 
C WORKS  WITH MAPS IN CCP4 FORMAT 
C version 2.ccp4:    Marius Schmidt May 2019
...
C GETRHO OPERATES ON BUFI. SINCE BUFI CONTAINS
C ALL THE MAP INCL. HEADER, MASK MUST CONTAIN 
C NGRID+NHDRS 
...
C FOR PYP (Z-SECTIONS, X-ROWS, Y-COLUMNS)
...
C 
C calculates the AVERAGE negative density BELOW -RS * AR1  in a mask
C 
...
C Z SECTIONS, ROWS IS X, COLUMNS IS Y E.G. FOR PYP
