...
C                         COLUMNS H,K,L,F,SIGF REQUIRED, 6th COLUMN IGNORED 
...
C             < F**2 >     < SIG(F)**2 >
C 
C NOTE ! OTHERS USES THE SQUARE OF THE MEAN OF THE ABSOLUTE VALUES (E.G. <|F|>**2)
...
C MARIUS SCHMIDT SEPT/OCT 2000
           ...
           DIMENSION FDARK(-250:250,-250:250,-250:250,3) 
C
...
C PHASES ARE READ IN
 ...
 1300      CONTINUE
           ...
           IF (PHASE.LE.-180.0) PHASE=PHASE+360.0
...
C BE CONSISTENT WITH OTHERS, EASY TO CHANGE (SEE BELOW)
